...
class Spot(BasePropertiesModel):
    ...
    address = models.OneToOneField(
        "locations.Address", blank=True, null=True, related_name="spot", verbose_name=_("Address")
    )
    sports = models.ManyToManyField("sports.Sport", blank=False, related_name="spots", verbose_name=_("Sports"))
